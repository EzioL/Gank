...
public class DailyData implements Serializable {
    ...
    public static class ResultsEntity {
        private List<Entity> android;
        private List<Entity> ios;
        private List<Entity> videoRest;
        private List<Entity> expandResources;
        private List<Entity> recommended;
        private List<Entity> welfare;
    }
}
